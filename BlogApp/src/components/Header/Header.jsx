              ...
              {authStatus ? (
                ...
                <li className="my-4 md:my-0">
                  ...
                  <NavLink
                    onClick={closeNavbar}
                    to={'/signup'}
                    className="md:ml-4 py-2 px-5 text-black button-custom  shadow-sm hover:scale-105 duration-200 hover:cursor-pointer bg-customPink hover:bg-slate-700  hover:text-gray-200 rounded-full"
                  >
                    {' '}
                    Signup{' '}
                  </NavLink>{' '}
                ...
                >
                  ...
                  >
                    <path
                      ...
                      fill="#334155"
                      className="duration-300 hover:fill-black"
                    />
                  </svg>
                </a>
              </li>
